"""
PyRIT Target Adapters Module

Adapts existing HttpGenerator and WebSocketGenerator to work with PyRIT orchestrator.
Wraps existing HTTP/WebSocket infrastructure for PyRIT PromptTarget compatibility.
"""
import logging
...
from services.swarm.garak_scanner.http_generator import HttpGenerator
...
class HttpTargetAdapter(PromptTarget):
    ...
    def __init__(
        ...
        """
        super().__init__()
        # Build expensive HTTP session once
    ...
    async def send_prompt_async(
        ...
        # Get the prompt text from the first request piece
        ...
        # Update the converted value with the response
