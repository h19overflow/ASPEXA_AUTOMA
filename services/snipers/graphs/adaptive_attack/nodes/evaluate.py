...
from services.snipers.graphs.adaptive_attack.state import AdaptiveAttackState, FailureCause
...
def evaluate_node(state: AdaptiveAttackState) -> dict[str, Any]:
    ...
    if is_successful:
        ...
        import asyncio
        try:
            from services.snipers.knowledge.integration import get_evaluate_hook
