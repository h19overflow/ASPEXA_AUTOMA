...
from services.snipers.knowledge.integration.models import HistoryContext
from services.snipers.knowledge.models.fingerprint import DefenseFingerprint
...
class AdaptNodeHook:
    ...
    def _get_processor(self):
        ...
        if self._processor is None and not self._config.log_only:
            try:
                from services.snipers.knowledge.query import get_query_processor
