...
with google_genai:gemini-3-flash-preview model.
"""
...
def get_default_agent(
    model_id: str = "google_genai:gemini-3-flash-preview",
...
def create_gemini_agent(
    ...
    Args:
        model_id: Model identifier (e.g., "google_genai:gemini-3-flash-preview")
        temperature: Sampling temperature (0.0-1.0)
...
def get_chat_target(
    ...
    if _default_chat_target is None:
        ...
        from services.snipers.infrastructure.pyrit.pyrit_init import init_pyrit
        init_pyrit()
