...
7.  **Attach Auditable Verification Report using Commit Message:**
    -   **Step 7.1: Update Plan:** Read `plan.md`, find the heading for the completed phase, and append the first 7 characters of the commit hash in the format `[checkpoint: <sha>]`.
